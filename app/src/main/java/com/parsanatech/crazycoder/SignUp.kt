...
class SignUp : AppCompatActivity() {
    ...
    private var uniqueFirebaseAuthId: String? = null
    private var googleSignInClient: GoogleSignInClient? = null
    private var Muniqueusername: String? = null
    private var finaldialog: Dialog? = null
        ...
        try {
            binding.signup.setOnClickListener {
                ...
                if (userEnterdName.isEmpty()) {
                    ...
                    binding.uiqueusername.error = "Please Enter your Name"
                ...
                if (EnteredPassword != EnteredConfirmPassword) {
                    Log.d(
                        "Main password and confirm password is not same",
                    ...
                    if (validate(userEnterdName)) {
                        ...
                        try {
                            ...
                            firestoreDb.collection("users").document("userNameToId").get()
                                .addOnSuccessListener { it ->
                                        ...
                                        if (it[userEnterdName] == null) {
                                            ...
                                            auth.createUserWithEmailAndPassword(
                                                    ...
                                                    currUser!!.sendEmailVerification()
                                                        .addOnSuccessListener {
                                                            try {
                                                                ...
                                                                finaldialog!!.setContentView(
                                                                    sentEmailbinding.root
                                                                )
                                                                finaldialog!!.setCanceledOnTouchOutside(
                                                                    true
                                                                )
                                                                ...
                                                                sentEmailbinding.closebtn.setOnClickListener {
                                                                    ...
                                                                    Log.d(
                                                                        "Email sent Dialog close button pressed",
                                                                        "Yes"
                                                                    )
                                                                }
                                                                finaldialog!!.show()
                                                                ...
                                                                Log.e(
                                                                    "Exception while showing Dialog",
                                                                    e.toString()
                                                                )
                                                            }
                                                ...
                                                try {
                                                    ...
                                                    Log.d(
                                                        "Error in New user Authentication",
                                                        e.toString()
                                                    )
                                                    progressbar.visibility = View.INVISIBLE

                                                    val dialogbinding =
                                                        ActivityWrongEmailsignupBinding.inflate(
                                                            layoutInflater
                                                        )
                                            ...
                                            if (uniqueFirebaseAuthId == null)
                                                Toast.makeText(
                                                    this@SignUp,
                                                    "Name $userEnterdName is already in use",
                                                    Toast.LENGTH_LONG
                                                ).show()
                                            progressbar.visibility = View.INVISIBLE
                                        }
                                    ...
                                    Toast.makeText(
                                        this@SignUp,
                                        "Some Error occured while connecting server",
                                        Toast.LENGTH_LONG
                                    ).show()
                                }
                        } catch (e: Exception) {
                        ...
                        progressbar.visibility = View.INVISIBLE
                        binding.uiqueusername.error = "A-Z a-z 0-9 _ are allowed"
                    }
        ...
        binding.signinwithgoogle.setOnClickListener {
            ...
            if (username.isEmpty()) {
                ...
                firestoreDb.collection("users").document("userNameToId").get()
                    ...
                    Log.e(
                        "Error while Reading stored name in signWithGoogle",
                        it.message.toString()
                    )
                    Toast.makeText(
                        this@SignUp,
...
//                    Log.d(TAG, "signInWithCredential:success")
                    ...
                    firestoreDb.collection("users").document(auth.uid.toString())
                        .set(finalUserINfirestore).addOnSuccessListener {

                        firestoreDb.collection("users").document("userNameToId")
                            .update(Muniqueusername.toString(), user.uid).addOnSuccessListener {
    ...
    private fun validate(userEnterdName: String): Boolean {

        for (i in 0 until userEnterdName.length) {
            if (!((userEnterdName[i] in 'a'..'z') || (userEnterdName[i] in 'A'..'Z') || (userEnterdName[i] in '0'..'9') || userEnterdName[i] == '_')) {
                return false
            }
        }
        return true
    ...
    fun saveUser(currUser: FirebaseUser) {
        ...
        try {
            ...
            if (currUser.isEmailVerified) {
                ...
                firestoreDb.collection("users").document(uniqueAuthId).set(verifieduserInfirestore)
                    .addOnCompleteListener {

                        firestoreDb.collection("users").document("userNameToId")
                            .update(userEnterdName, uniqueAuthId).addOnSuccessListener {
                            ...
                            Log.e(
                                "Error in second request inside saveuser fun",
                                it.message.toString()
                            )
                        }
                ...
                Log.d(
                    ...
                    "$currUser -> ${currUser.isEmailVerified}"
                )
