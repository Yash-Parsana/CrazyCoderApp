...
class SignIn : AppCompatActivity() {
    ...
    var name = ""
    private var checkforonreume = false
                    ...
                    .addOnCompleteListener { task ->
                        ...
                        if (task.isSuccessful) {
                            ...
                            if (auth.currentUser!!.isEmailVerified) {
                                ...
                                if (name.isEmpty()) {
                                    Log.d(
                                        "UserName is Empty so Reading from firestore to save in sharedpreference",
                                        "Yes"
                                    )
                                    firestoreDb.collection("users").document(auth.uid.toString())
                                        .get().addOnSuccessListener {
                                            ...
                                            try {
                                                ...
                                                Log.e(
                                                    "Exception while storing Sharedpreference",
                                                    e.toString()
                                                )
                                            }
                        ...
                        try {
                            ...
                            val dialogbinding =
                                ActivityWrongEmailsignupBinding.inflate(layoutInflater)
...
//                    auth.cp;
                        ...
                        auth.sendPasswordResetEmail(inneremail).addOnSuccessListener {
                            ...
                            try {
                                val innerDialogBinding =
                                    ActivityPasswordResetLinkSentBinding.inflate(layoutInflater)
        ...
        try {
            ...
            dialogbinding.closebtn.setOnClickListener {      //close button in wrong email signup binding is changed as verify now but is is still same
                ...
                auth.currentUser!!.sendEmailVerification().addOnSuccessListener {
                    ...
                    try {
                        val sentEmailbinding = ActivityEmailVarificationSignUpBinding.inflate(
                            layoutInflater
                        )
                            ...
                            .addOnSuccessListener {
                                ...
                                try {
                                    if (it[username] == null) {
                                        firestoreDb.collection("users").document(curruser.uid).set(
                                            ...
                                            firestoreDb.collection("users").document("userNameToId")
                                                ...
                                                .addOnSuccessListener {
                                                    ...
                                                    Log.e(
                                                        "Error in storing userName:id pair",
                                                        it.toString()
                                                    )
                                                    Toast.makeText(
                                                        this@SignIn,
                                            ...
                                            Log.e(
                                                "Error while storing user on Firestore",
                                                it.toString()
                                            )
                                            Toast.makeText(
                                                this@SignIn,
                                        ...
                                        dialogbinding.progressbar.visibility = View.INVISIBLE
                                        if (avoidRpeatation) Toast.makeText(
                                            this@SignIn,
                                    ...
                                    Log.e(
                                        "Exception in Reading save user SignIn Activity",
                                        e.toString()
                                    )
                                }
                                ...
                                Log.e(
                                    "Error in Reading username:id pair in saveuser signIn Activity",
                                    it.toString()
                                )
                                dialogbinding.progressbar.visibility = View.INVISIBLE
                                Toast.makeText(
    ...
    private fun validate(userEnterdName: String): Boolean {
        ...
        for (i in userEnterdName.indices) {
